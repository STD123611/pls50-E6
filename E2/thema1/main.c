...
struct passenger
{
    char name[40];  //Eponymo onoma
    char phone[10]; //tel me xrisi u (usigned)
    int seat[53];  //thesi ka8ismatos
} pas;
...
// sim1:DEN moy epistrefei to unsigned tou tilefvnou sthn scanf..
...
struct passenger
{
            int id;  //dilvsame san "i" ton ariumo ueswn toy lewforioy
            char name[40]; //dilvsame to onomateonymo toy epibati
            int phone;  //dilwsame ton ariumo tilefwnoy
};
struct passenger pass; // Global declaration of structure
       ...
       /*    for (i=0;i<seats;i++)
        ...
        case 2:
           ...
           /*   printf("arithmos thesis ektos oriwn\n");
             ...
             /*   scanf("Dwse onomateponymo %s, Diale3e thesi %d, Dwse tilefono",)
